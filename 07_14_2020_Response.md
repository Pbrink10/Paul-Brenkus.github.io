...
### 3.) Compared to the DNN, CNN seems like the more plausible option in terms of Neural Networks. Within the first epoch, the CNN was already at 0.9875 accuracy with 0.0398 loss, while the DNN ended the last epoch at 0.9735. 
